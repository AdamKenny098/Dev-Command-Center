...
export const projectSeed: Project[] = [
    ...
    boards: [
      {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Make reservations properly block generic decoration passes.",
            priority: "Critical",
            due: "Today",
            urgent: true,
            column: "next",
    ...
    activity: [
      {
        id: "a1",
        type: "system",
        summary: "Seeded project workspace",
        detail: "Initial command-center project data was loaded.",
  ...
  },
  {
    ...
    nextAction: "Finish V3.4 to V3.7 and lock the local command-center loop.",
    blockers: [],
    ...
    boards: [
      {
        ...
        description:
          "Home command center, projects grid, project detail workspace, persistence, editing, trace, and intelligence.",
        cards: [
          {
            id: "c9",
            title: "Add activity trace",
            description:
              "Every workspace mutation should record a readable project activity entry.",
            priority: "Critical",
            due: "Today",
            urgent: true,
            column: "doing",
          ...
          {
            id: "c10",
            title: "Complete task and note editing",
            description:
              "Allow tasks and notes to be created, changed, and removed from the workspace.",
            priority: "High",
            due: "Today",
            urgent: true,
            column: "next",
          },
          {
            ...
            description:
              "Let projects be created and maintained without editing JSON by hand.",
            priority: "High",
            due: "Tomorrow",
            column: "next",
          },
          {
            id: "c12",
            title: "Smarter home dashboard",
            description:
              "Expose blocked, stale, urgent, and recently changed work at a glance.",
            priority: "High",
            due: "Tomorrow",
            column: "backlog",
          },
      ...
      },
      {
        ...
        name: "Future Backend",
        description:
          "SQLite migration, local repo awareness, command APIs, and Chernobog integration.",
        cards: [
          {
            id: "c13",
            title: "Draft SQLite shape",
            description:
              "Project, Board, Card, Note, Link, ActivityEntry once JSON stops being enough.",
            priority: "Medium",
            due: "Later",
            column: "backlog",
          },
          {
            id: "c14",
            title: "Define command boundary",
            description:
              "Decide what Chernobog can read and update through controlled actions.",
            priority: "Medium",
            due: "Later",
            column: "backlog",
          },
    ...
    activity: [
      {
        id: "a2",
        type: "system",
        summary: "Seeded command-center workspace",
        detail: "Project Command Center is the primary project for this sprint.",
    ...
    boards: [
      {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Make sure evidence and terminology stay consistent.",
            priority: "High",
            due: "Today",
            urgent: true,
            column: "doing",
    ...
    activity: [
      {
        id: "a3",
        type: "system",
        summary: "Seeded VeriLite workspace",
        detail: "Polish-stage project added to the command center.",
